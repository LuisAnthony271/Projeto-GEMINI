  ...
  return (
    <section className={styles.learn}>
        <div className={styles.learnWrapper}>
            <h2>Como funciona o metodo de aprendizado do Gemini?</h2>
            <p>O Gemini, como outros modelos de linguagem grandes (LLMs) modernos, utiliza principalmente o método de aprendizado de máquina chamado aprendizado supervisionado em larga escala, com algumas nuances importantes devido à sua natureza multimodal. Vamos detalhar como esse processo funciona para o Gemini:<br /> <br />
